...
const wording={
 ja:{title:'スキル情報',description:'スキル説明',effects:'スキル効果',loading:'スキル情報を読み込み中…',unavailable:'スキル情報を現在取得できません。意見欄は利用できます。',retry:'再取得',source:'取得元を見る',discussion:'このキャラ専用の意見・投票・動画です。'},
 en:{title:'Skills',description:'Description',effects:'Skill effects',loading:'Loading skills…',unavailable:'Skills are temporarily unavailable. This character’s discussion is still available.',retry:'Retry',source:'View source',discussion:'Opinions, votes and videos here belong to this character only.'},
 zh:{title:'技能資訊',description:'技能說明',effects:'技能效果',loading:'正在載入技能…',unavailable:'暫時無法取得技能資訊。仍可查看此角色的討論。',retry:'重試',source:'查看來源',discussion:'此處的意見、投票與影片僅屬於這名角色。'},
 th:{title:'ข้อมูลสกิล',description:'คำอธิบายสกิล',effects:'เอฟเฟกต์สกิล',loading:'กำลังโหลดสกิล…',unavailable:'ยังโหลดข้อมูลสกิลไม่ได้ แต่กระดานของตัวละครนี้ยังใช้งานได้',retry:'ลองอีกครั้ง',source:'ดูแหล่งข้อมูล',discussion:'ความคิดเห็น โหวต และวิดีโอในหน้านี้เป็นของตัวละครนี้เท่านั้น'},
