...
test('comment UI keeps reactions private, opens replies on demand, and marks a selected reply target',()=>{
 ...
 assert.match(communitySource,/replyTarget/);assert.match(communitySource,/toggleReplies/);assert.match(communitySource,/t\.showReplies\.replace/);assert.doesNotMatch(communitySource,/translatePost|<Languages/);assert.match(communitySource,/replyingTo/);assert.match(communitySource,/parent\?:string\|null/);assert.match(communitySource,/function canReplyToPost/);assert.match(communitySource,/const replyEnabled=canReplyToPost\(p,isReply\)/);assert.match(communitySource,/replyEnabled&&/);assert.match(communitySource,/post-meta.*badges\.map/s);assert.match(communitySource,/data-badge=\{badge\}/);assert.match(communitySource,/post-author-line/);assert.match(communitySource,/contribution-title/);assert.match(communitySource,/post-badge-mark/);assert.match(communitySource,/data-badge=\{badge\}/);assert.match(communityCss,/\.post-badge-mark/);
